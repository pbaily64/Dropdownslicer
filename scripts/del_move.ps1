# del_move.ps1 — renomme le .pbiviz fraîchement généré en DropdownSlicer.pbiviz

# Le script s'exécute depuis le dossier où il se trouve (dist/)
$scriptDir = Split-Path -Parent $MyInvocation.MyCommand.Definition
Set-Location $scriptDir

$target = "DropdownSlicer.pbiviz"
$prefix = "dropdownSlicerD845CCC7326D4A259FE283D20B4BD5B0"
